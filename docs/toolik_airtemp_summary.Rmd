...
```{r}
# myAwesomeChart <- ggplot(data = toolik_weather, aes(x = month, y = daily_air_temp_mean_c, color = daily_air_temp_mean_c)) + geom_jitter() + labs(x = "Month", y = "Daily Air Temp (C)") + scale_color_gradient(low = "blue", high = "orange")
# 
# ggsave(plot = myAwesomeChart, here("figs", "myAwesomeChart.png"), height = 5, width = 6)
```

ctrl+shift+c : turns lines into comments and vice versa
